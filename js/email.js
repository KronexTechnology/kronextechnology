            ...
            <div class="email-wrapper">
                <div class="email-container">
                    <div class="email-header">
                        <h1>New Inquiry from Kronex Technology</h1>
                    </div>
                    ...
                    <div class="email-footer">
                        <p>© ${currentYear} Kronex Technology. All Rights Reserved</p>
                        <p><a href="https://kronextechnology.vercel.app/" target="_blank">My portfolio</a></p>
                    </div>
                </div>
            </div>
        </body>
